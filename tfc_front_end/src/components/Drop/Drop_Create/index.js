...
const Create_Drop = () => {
    ...
    //////////////////////////////////////////////////////////////////////////////
    // THURSDAY CODE-> TACKLE PROBLEM OF MULTI PAGE FETCH TO SHOW ALL CLASSES INFO
    ...
    const handleFormChange = (e) => {
        ...
        console.log("What is my drop data: ", dropData['modify_future_classes'])
        if (e.target.name == "class_info"){
            ...
            dropData["class_info"] = parseInt(extractedID)
        ...
        if (e.target.name == "user"){
            dropData["user"] = parseInt(dropData["user"])
    ...
    const submitDropData = () => {
        const dropFormData = new FormData();
        console.log("nani tf", dropData["modify_future_classes"])
        dropFormData.append("modify_future_classes", dropData.modify_future_classes);
        dropFormData.append("user", dropData.user);
        dropFormData.append("class_info", dropData.class_info);

        // Post the data
        console.log(dropFormData)
        try{
