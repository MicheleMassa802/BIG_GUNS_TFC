    ...
    render(){
        return (
            <div>
                ...
                <input type="text" name="enroll_class" placeholder="Class ID (Should be dropdown which when selected displays name but gives ID))" required/>
                <br></br> 
            </div>
        )
    }
